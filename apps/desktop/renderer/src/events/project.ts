...
export function projectEvent(event: KnownEvent): EventView {
  switch (event.variant) {
    ...
    case "docket.review_requested": return layout(event, "Review requested", [["reviewer", "Reviewer", "header"], ["requested_by", "Requested by", "header"], ["owner", "Assigned to", "header"], ["objective", "Objective", "body"], ["acceptance", "Acceptance conditions", "context"], ["done_so_far", "Completed", "context"]])
