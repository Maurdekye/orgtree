...
export function projectEvent(event: KnownEvent): EventView {
  switch (event.variant) {
    ...
    case "docket.participant_added": return layout(event, "Participation added", [["added_by", "Added by", "context"], ["owner", "Assigned to", "context"], ["objective_notice", "Scope warning", "body"], ["objective", "Objective", "body"]])
