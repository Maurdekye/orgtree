...
export function projectEvent(event: KnownEvent): EventView {
  switch (event.variant) {
    ...
    case "docket.assigned": return layout(event, "Assignment", [["owner", "Assigned to", "header"], ["previous_owner", "Previously assigned to", "header"], ["assigner", "Assigned by", "header"], ["status", "Status", "header"], ["objective", "Objective", "body"], ["acceptance", "Acceptance conditions", "context"], ["done_so_far", "Completed", "context"], ["working_on_next", "Next steps", "context"]])
    case "docket.review_requested": return layout(event, "Review requested", [["reviewer", "Reviewer", "header"], ["requested_by", "Requested by", "header"], ["owner", "Assigned to", "header"], ["revision", "Item revision", "header"], ["candidate", "Candidate", "header"], ["objective", "Objective", "body"], ["acceptance", "Acceptance conditions", "context"], ["done_so_far", "Completed", "context"]])
    ...
    case "lifecycle.cheap_compacted": return layout(event, "Session reset", [["node", "Node", "context"], ["relation", "Relation", "context"], ["by", "By", "context"], ["predecessor", "Predecessor", "context"], ["team_note", "Team note", "context"], ["request_note", "Request note", "context"]])
    ...
    case "lifecycle.subtree_promoted": return layout(event, "Subtree promoted", [["promoted", "Promoted", "context"], ["demoted", "Demoted", "context"], ["role", "Role", "context"], ["by", "By", "context"], ["reports_to_after", "Reports to after", "context"], ["subtree", "Subtree", "context"]])
