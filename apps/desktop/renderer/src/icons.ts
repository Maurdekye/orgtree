...
export { default as MaximizeIcon } from '@mui/icons-material/CheckBoxOutlineBlank'
export { default as MinimizeIcon } from '@mui/icons-material/Remove'
export { default as RestoreIcon } from '@mui/icons-material/FilterNone'
