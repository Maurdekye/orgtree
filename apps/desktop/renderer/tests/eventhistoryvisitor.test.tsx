...
test('history renders typed status and preserves legacy and unsupported content',async t=>{
  ...
  const event={...f.public,summary:'Visible status summary C'}
  const items=[{at:'2026-09-06T12:00:00Z',kind:'notice',actor:'system',detail:{text:'Legacy status projection'},ev_public:event},
    {at:'2026-09-06T12:01:00Z',kind:'notice',actor:'system',detail:{text:'Literal [DONE] older notice'}},
    {at:'2026-09-06T12:02:00Z',kind:'notice',actor:'system',detail:{text:'Unknown format retained'},ev_error:{code:'variant'}}]
