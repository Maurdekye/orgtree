// Bundle the real pending/settled mail fixture for pendparity_probe.py.
...
if (!out) { console.error('usage: node tests/pendparity-build.mjs <outdir>'); process.exit(2) }
rmSync(out, { recursive: true, force: true })
mkdirSync(out, { recursive: true })
await esbuild.build({
  entryPoints: [path.join(HERE, 'pendparity-probe.tsx')],
