// Bundle the real ReplyPreview + composer-shape browser fixture for
// replysize_probe.py. Same pattern as cardlayout-build.mjs.
...
if (!out) { console.error('usage: node tests/replysize-build.mjs <outdir>'); process.exit(2) }
rmSync(out, { recursive: true, force: true })
mkdirSync(out, { recursive: true })
await esbuild.build({
  entryPoints: [path.join(HERE, 'replysize-probe.tsx')],
