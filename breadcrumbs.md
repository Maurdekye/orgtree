...
- 2026-09-07: Outbound attachment uploads persist each hub blob ID in the offline spool before sending the message, preventing repeated blob uploads across retries.
