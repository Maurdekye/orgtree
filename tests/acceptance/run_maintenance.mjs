...
const result=spawnSync(electron,acceptanceLaunchArgs(path.join(here,'maintenance.cjs')),{cwd:target,env,encoding:'utf8',windowsHide:true,timeout:80000,maxBuffer:1024*1024})
