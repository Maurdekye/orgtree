...
Every test of `test_manual_inbox` re-run with the transition fence OFF and
...
Run:  python tools/run-python-verification.py tests/test_manual_inbox_fence_off.py
"""
import sys
...
import test_manual_inbox as base  # noqa: E402  (sets this run's data root)
...
class ManualInboxFenceOff(base.ManualInboxTests):
    def setUp(self):
        super().setUp()
